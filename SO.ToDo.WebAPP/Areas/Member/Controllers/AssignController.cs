...
namespace SO.ToDo.WebAPP.Areas.Member.Controllers
{
    ...
    public class AssignController : Controller
    {
        ...
        public AssignController(IMyTaskService myTaskService, UserManager<AppUser> userManager, IRapportService rapportService, INotificationService notificationService)
        {
